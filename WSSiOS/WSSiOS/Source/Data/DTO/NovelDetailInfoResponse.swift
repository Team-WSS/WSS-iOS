...
struct NovelDetailInfoResponse: Decodable {
...
extension NovelDetailInfoResponse {
    static let dummyFullData = [
        NovelDetailInfoResponse(
            ...
            platforms: [PlatformResponse(platformName: "네이버시리즈",
                                                    platformImage: "/platform/naver-series",
                                                    platformURL: "https://namu.wiki/w/당신의%20이해를%20돕기%20위하여"),
                        PlatformResponse(platformName: "카카오페이지",
                                                    platformImage: "/platform/naver-series",
                                                    platformURL: "https://page.kakao.com/content/53706168")],
            attractivePoints: ["character",
                               "relationship",
                               "material"],
            keywords: [KeywordResponse(keywordName: "서양풍/중세시대",
                                                  keywordCount: 7),
                       KeywordResponse(keywordName: "웹툰화",
                                                  keywordCount: 5),
                       KeywordResponse(keywordName: "동양풍/사극",
                                                  keywordCount: 3),
                       KeywordResponse(keywordName: "실존역사",
                                                  keywordCount: 2),
                       KeywordResponse(keywordName: "현대",
                                                  keywordCount: 2)],
            watchingCount: 130,
            watchedCount: 10,
            quitCount: 100)
