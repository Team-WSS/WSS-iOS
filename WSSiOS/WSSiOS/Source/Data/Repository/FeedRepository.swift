...
struct TestFeedRepository: FeedRepository {
    ...
    func getSingleFeedData() -> Observable<Feed> {
        return Observable.just(Feed(userProfileImage: "https://i.pinimg.com/564x/d6/01/72/d60172b19b2a70f0e64282ac769cbe00.jpg",
                                    userNickName: "구리구리스",
                                    createdDate: "10월 3일",
                                    content: "여름 햇살이 뜨겁게 내리쬐던 어느 오후, 작은 마을의 공원에서 아이들의 웃음소리가 가득했다. 그들은 공놀이를 하며 즐거운 시간을 보내고 있었다. 나무 그늘 아래에는 노부부가 벤치에 앉아 이야기를 나누고 있었다. 그들은 서로의 손을 꼭 잡고 오랜 추억을 이야기하며 미소를 지었다. 공원의 풍경은 평화롭고 아름다웠다. 바람에 흔들리는 나뭇잎 소리와 함께 새들의 지저귐이 어우러져 한 폭의 그림 같았다. 시간이 천천히 흐르는 듯한 그곳에서, 사람들은 일상의 소소한 행복을 만끽하고 있었다.",
