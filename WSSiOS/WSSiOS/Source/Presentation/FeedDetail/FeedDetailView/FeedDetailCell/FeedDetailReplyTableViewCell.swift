//
//  FeedDetailReplyTableViewCell.swift
//  WSSiOS
//
...
final class FeedDetailReplyTableViewCell: UITableViewCell {
    ...
    private func setUI() {
        ...
        createdDateLabel.do {
            $0.applyWSSFont(.body5, with: "10월 3일")
            $0.textColor = .wssBlack
        }
        
        isModifiedLabel.do {
            $0.applyWSSFont(.body5, with: "(수정됨)")
            $0.textColor = .wssGray200
        }
        
        replyContentLabel.do {
            $0.applyWSSFont(.body2, with: "헐 대박 너무 재미있습니다. 어떻게 이렇게 재미있을 수가슈가슈가룬?")
            $0.textColor = .wssBlack
            $0.numberOfLines = 0
        }
