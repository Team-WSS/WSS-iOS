//
//  DetailSearchKeywordCategoryView.swift
//  WSSiOS
//
//  Created by Seoyeon Choi on 7/22/24.
//
...
final class DetailSearchKeywordCategoryView: UIView {
    ...
    private func setUI() {
        ...
        keywordTitleLabel.do {
            $0.applyWSSFont(.title2, with: StringLiterals.DetailSearch.world)
