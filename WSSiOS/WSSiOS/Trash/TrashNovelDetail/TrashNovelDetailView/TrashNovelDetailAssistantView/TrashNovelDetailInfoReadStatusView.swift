//
//  TrashNovelDetailInfoReadStatusView.swift
//  WSSiOS
//
...
final class TrashNovelDetailInfoReadStatusView: UIView {
    
    //MARK: - Components

    private let dividerView = UIView()
    private let readStatusLabel = UILabel()
    private let readStatusTagView = TrashNovelDetailInfoReadStatusTagView()
