...
final class TrashNovelDetailView: UIView {
    ...
    let novelDetailHeaderView = TrashNovelDetailHeaderView()
    let novelDetailTabView = TrashNovelDetailTabView()
    let novelDetailMemoView = TrashNovelDetailMemoView()
    let novelDetailInfoView = TrashNovelDetailInfoView()
    let createMemoButton = DifferentRadiusButton()
    let stickyNovelDetailTabView = TrashNovelDetailTabView()
    let novelDetailMemoSettingButtonView = TrashNovelDetailMemoSettingButtonView()
    ...
    func changeCurrentMenu(menu: TrashSelectedMenu) {
        switch menu {
        case .memo:
