//
//  TrashNovelDetailViewController.swift
//  WSSiOS
//
...
final class TrashNovelDetailViewController: UIViewController {
    
    //MARK: - Properties

    private let novelDetailViewModel: TrashNovelDetailViewModel
    ...
    private let rootView = TrashNovelDetailView()
    private let backButton = UIButton()
    private let novelSettingButton = UIButton()
    
    //MARK: - Life Cycle
    
    init(viewModel: TrashNovelDetailViewModel, userNovelId: Int) {
...
//        )
    ...
    private func register() {
        rootView.novelDetailMemoView.memoTableView.register(
            TrashNovelDetailMemoTableViewCell.self,
            forCellReuseIdentifier: TrashNovelDetailMemoTableViewCell.cellIdentifier
        )
        rootView.novelDetailInfoView.novelDetailInfoPlatformView.platformCollectionView.register(
            TrashNovelDetailInfoPlatformCollectionViewCell.self,
            forCellWithReuseIdentifier: TrashNovelDetailInfoPlatformCollectionViewCell.cellIdentifier
        )
    }
    ...
    private func bindViewModel() {
        let input = TrashNovelDetailViewModel.Input(
        ...
        output.memoList.bind(to: rootView.novelDetailMemoView.memoTableView.rx.items(
            cellIdentifier: TrashNovelDetailMemoTableViewCell.cellIdentifier,
            cellType: TrashNovelDetailMemoTableViewCell.self)) { row, element, cell in
        ...
        output.platformList.bind(to: rootView.novelDetailInfoView.novelDetailInfoPlatformView.platformCollectionView.rx.items(
            ...
            cellType: TrashNovelDetailInfoPlatformCollectionViewCell.self)) { item, element, cell in
...
extension TrashNovelDetailViewController: UICollectionViewDelegateFlowLayout {
